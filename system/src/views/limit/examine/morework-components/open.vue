...
<script>
import { limitMorework, limitMoreworkAdd ,limitMoreworkEdit} from "@/api/limit.js";
export default {
  props: {
    value: {},
    row: {}, //编辑数据
        ...
        if (valid) {
          ...
          if(this.isEdit){
            limitMoreworkEdit({
              ...
              festival_value:this.form.festival_value
              }).then((res)=>{
